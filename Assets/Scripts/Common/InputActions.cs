...
//     version 1.8.2
//     from Assets/Packages/EntityComponentSystemSamples-master/PhysicsSamples/Assets/Common/InputActions.inputactions
//
...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputActions()
    {
        Debug.Assert(!m_CharacterController.enabled, "This will cause a leak and performance issues, InputActions.CharacterController.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputActions.UI.Disable() has not been called.");
        Debug.Assert(!m_Vehicle.enabled, "This will cause a leak and performance issues, InputActions.Vehicle.Disable() has not been called.");
    }
