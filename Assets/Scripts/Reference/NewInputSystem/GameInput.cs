...
//     version 1.14.2
//     from Assets/Scripts/Reference/NewInputSystem/InputAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Reference/NewInputSystem/InputAction.inputactions".
/// </summary>
/// <remarks>
...
public partial class @RavineGameInput: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        // Trash (Dont use)
        m_TrashDontuse = asset.FindActionMap("Trash (Dont use)", throwIfNotFound: true);
        m_TrashDontuse_Newaction = m_TrashDontuse.FindAction("New action", throwIfNotFound: true);
        m_TrashDontuse_MobileTouch = m_TrashDontuse.FindAction("MobileTouch", throwIfNotFound: true);
        m_TrashDontuse_Point = m_TrashDontuse.FindAction("Point", throwIfNotFound: true);
    }
    ...
    ~@RavineGameInput()
    {
        ...
        UnityEngine.Debug.Assert(!m_TrashDontuse.enabled, "This will cause a leak and performance issues, RavineGameInput.TrashDontuse.Disable() has not been called.");
    }
    ...
    public struct GameplayActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Gameplay/MovementWASD".
        /// </summary>
        public InputAction @MovementWASD => m_Wrapper.m_Gameplay_MovementWASD;
        /// <summary>
        /// Provides access to the underlying input action "Gameplay/JumpSpace".
        /// </summary>
        public InputAction @JumpSpace => m_Wrapper.m_Gameplay_JumpSpace;
        /// <summary>
        /// Provides access to the underlying input action "Gameplay/EnterEnter".
        /// </summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "Gameplay/InventoryEnterE".
        /// </summary>
    ...
    public struct UIActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "UI/MobileTouch".
        /// </summary>
    ...
    public struct InventoryActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Inventory/InventoryQuitE".
        /// </summary>
    ...
    // Trash (Dont use)
    private readonly InputActionMap m_TrashDontuse;
    private List<ITrashDontuseActions> m_TrashDontuseActionsCallbackInterfaces = new List<ITrashDontuseActions>();
    private readonly InputAction m_TrashDontuse_Newaction;
    private readonly InputAction m_TrashDontuse_MobileTouch;
    private readonly InputAction m_TrashDontuse_Point;
    /// <summary>
    /// Provides access to input actions defined in input action map "Trash (Dont use)".
    /// </summary>
    public struct TrashDontuseActions
    {
        private @RavineGameInput m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TrashDontuseActions(@RavineGameInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "TrashDontuse/Newaction".
        /// </summary>
        public InputAction @Newaction => m_Wrapper.m_TrashDontuse_Newaction;
        /// <summary>
        /// Provides access to the underlying input action "TrashDontuse/MobileTouch".
        /// </summary>
        public InputAction @MobileTouch => m_Wrapper.m_TrashDontuse_MobileTouch;
        /// <summary>
        /// Provides access to the underlying input action "TrashDontuse/Point".
        /// </summary>
        public InputAction @Point => m_Wrapper.m_TrashDontuse_Point;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_TrashDontuse; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="TrashDontuseActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(TrashDontuseActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="TrashDontuseActions" />
        public void AddCallbacks(ITrashDontuseActions instance)
        {
            if (instance == null || m_Wrapper.m_TrashDontuseActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TrashDontuseActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="TrashDontuseActions" />
        private void UnregisterCallbacks(ITrashDontuseActions instance)
        {
            @Newaction.started -= instance.OnNewaction;
            @Newaction.performed -= instance.OnNewaction;
            @Newaction.canceled -= instance.OnNewaction;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="TrashDontuseActions.UnregisterCallbacks(ITrashDontuseActions)" />.
        /// </summary>
        /// <seealso cref="TrashDontuseActions.UnregisterCallbacks(ITrashDontuseActions)" />
        public void RemoveCallbacks(ITrashDontuseActions instance)
        {
            if (m_Wrapper.m_TrashDontuseActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="TrashDontuseActions.AddCallbacks(ITrashDontuseActions)" />
        /// <seealso cref="TrashDontuseActions.RemoveCallbacks(ITrashDontuseActions)" />
        /// <seealso cref="TrashDontuseActions.UnregisterCallbacks(ITrashDontuseActions)" />
        public void SetCallbacks(ITrashDontuseActions instance)
        {
            foreach (var item in m_Wrapper.m_TrashDontuseActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TrashDontuseActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="TrashDontuseActions" /> instance referencing this action map.
    /// </summary>
    public TrashDontuseActions @TrashDontuse => new TrashDontuseActions(this);
    /// <summary>
    ...
    {
        /// <summary>
        /// Method invoked when associated input action "Movement (WASD)" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        ...
        /// <summary>
        /// Method invoked when associated input action "Jump (Space)" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "Enter (Enter)" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "InventoryEnter (E)" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "Digit (1-8)" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
    ...
    public interface IUIActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "MobileTouch" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
    ...
    {
        /// <summary>
        /// Method invoked when associated input action "InventoryQuit (E)" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Trash (Dont use)" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="TrashDontuseActions.AddCallbacks(ITrashDontuseActions)" />
    /// <seealso cref="TrashDontuseActions.RemoveCallbacks(ITrashDontuseActions)" />
    public interface ITrashDontuseActions
    {
        /// <summary>
