...
public partial class @RavineGameInput: IInputActionCollection2, IDisposable
{
    ...
    ~@RavineGameInput()
    {
        Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, RavineGameInput.Gameplay.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, RavineGameInput.UI.Disable() has not been called.");
        Debug.Assert(!m_TextInput.enabled, "This will cause a leak and performance issues, RavineGameInput.TextInput.Disable() has not been called.");
        Debug.Assert(!m_Inventory.enabled, "This will cause a leak and performance issues, RavineGameInput.Inventory.Disable() has not been called.");
        Debug.Assert(!m_TrashDontuse.enabled, "This will cause a leak and performance issues, RavineGameInput.TrashDontuse.Disable() has not been called.");
    }
